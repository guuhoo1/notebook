    ...
    <div class="w-full max-w-md">
      ...
      <div class="bg-canvas border border-hairline rounded-lg p-8">
        <form @submit.prevent="handleRegister">
          <div class="space-y-4">
            <div>
              <label class="block text-label-md text-ink mb-2">昵称 <span class="text-red-500">*</span></label>
              <input
            ...
            <div>
              <label class="block text-label-md text-ink mb-2">密码 <span class="text-red-500">*</span></label>
              <div class="relative">
                <input
            ...
            <div>
              <label class="block text-label-md text-ink mb-2">确认密码 <span class="text-red-500">*</span></label>
              <input
        ...
        <div class="mt-6 text-center">
          ...
          <button class="text-link hover:underline ml-1" @click="goLogin">
            立即登录
          </button>
        </div>
      </div>
